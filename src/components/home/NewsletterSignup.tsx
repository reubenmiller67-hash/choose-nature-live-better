          ...
          <div>
            ...
            <div className="space-y-4 max-w-md">
              ...
              <button
                ...
                disabled={isLoading}
                className="inline-flex items-center justify-center gap-2 bg-[#22C55E] text-white rounded-full px-8 py-4 text-lg font-semibold hover:bg-[#16A34A] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
              >
